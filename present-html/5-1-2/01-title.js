...
registerSlide({
  ...
  <div style="flex:1; display:flex; flex-direction:column; justify-content:center; gap:1rem; max-width:58rem">
    ...
    <p class="lead muted" data-kz="Натурал сандарды және нөл санын координаталық сәуледе кескіндеу"
       data-ru="Изображение натуральных чисел и нуля на координатном луче"></p>
    ...
    <div class="row">
      ...
      <div class="card tight"><b data-kz="③ Бағыты" data-ru="③ Направление"></b></div>
    </div>
  </div>`,
  init: function(){
    function paint(){
