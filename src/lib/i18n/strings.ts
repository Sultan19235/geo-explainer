...
export const STRINGS = {
  kz: {
    ...
    // Admin: teacher access (enrollments)
    ua_access_title: "Қолжетімділік",
    ua_access_none: "Белсенді қолжетімділік жоқ.",
    ua_access_unavailable:
      "Қолжетімділік кестесі әлі жоқ — teacher_grade_enrollments миграциясы қолданылмаған.",
    ua_access_until: (date: string) => `${date} дейін`,
    ua_access_unlimited: "мерзімсіз",
    ua_access_ended: (date: string) => `бітті: ${date}`,
    ua_access_col: "Қолжетімділік",
    ua_totals_with_access: "Қолжетімділігі бар",
    ua_enroll_title: "Қолжетімділік беру",
    ua_enroll_grades: "Сыныптар",
    ua_enroll_all_grades: "Барлығы",
    ua_enroll_clear: "Тазалау",
    ua_enroll_period: "Мерзім",
    ua_enroll_month: (n: number) => `${n} ай`,
    ua_enroll_year: "1 жыл",
    ua_enroll_unlimited: "Мерзімсіз",
    ua_enroll_until_date: "Күнге дейін",
    ua_enroll_label: "Белгі (пакет / төлем)",
    ua_enroll_label_hint: "Мысалы: «3 сынып пакеті, Kaspi, 09.2026»",
    ua_enroll_submit: "Беру",
    ua_enroll_saving: "Сақталуда…",
    ua_enroll_pick_grades: "Кемінде бір сынып таңдаңыз.",
    ua_enroll_pick_date: "Күнді таңдаңыз (болашақтағы).",
    ua_history_title: "Қолжетімділік тарихы",
    ua_history_none: "Әзірге жазбалар жоқ.",
    ua_history_col_grade: "Сынып",
    ua_history_col_period: "Кезең",
    ua_history_col_status: "Күйі",
    ua_history_col_label: "Белгі",
    ua_history_col_created: "Берілген",
    ua_enr_status_active: "Белсенді",
    ua_enr_status_expired: "Мерзімі біткен",
  ...
  ru: {
    ...
    // Admin: teacher access (enrollments)
    ua_access_title: "Доступ",
    ua_access_none: "Нет активного доступа.",
    ua_access_unavailable:
      "Таблица доступа ещё не создана — миграция teacher_grade_enrollments не применена.",
    ua_access_until: (date: string) => `до ${date}`,
    ua_access_unlimited: "бессрочно",
    ua_access_ended: (date: string) => `истёк: ${date}`,
    ua_access_col: "Доступ",
    ua_totals_with_access: "С доступом",
    ua_enroll_title: "Открыть доступ",
    ua_enroll_grades: "Классы",
    ua_enroll_all_grades: "Все",
    ua_enroll_clear: "Очистить",
    ua_enroll_period: "Срок",
    ua_enroll_month: (n: number) => `${n} ${ruPlural(n, "месяц", "месяца", "месяцев")}`,
    ua_enroll_year: "1 год",
    ua_enroll_unlimited: "Бессрочно",
    ua_enroll_until_date: "До даты",
    ua_enroll_label: "Метка (пакет / оплата)",
    ua_enroll_label_hint: "Например: «пакет 3 класса, Kaspi, 09.2026»",
    ua_enroll_submit: "Открыть",
    ua_enroll_saving: "Сохранение…",
    ua_enroll_pick_grades: "Выберите хотя бы один класс.",
    ua_enroll_pick_date: "Укажите дату (в будущем).",
    ua_history_title: "История доступа",
    ua_history_none: "Записей пока нет.",
    ua_history_col_grade: "Класс",
    ua_history_col_period: "Период",
    ua_history_col_status: "Статус",
    ua_history_col_label: "Метка",
    ua_history_col_created: "Выдан",
    ua_enr_status_active: "Активен",
    ua_enr_status_expired: "Истёк",
